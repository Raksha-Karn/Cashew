...
class TransactionManager:
    ...
    def view_transaction_summary(self):
        ...
        print("\n===== FINANCIAL SUMMARY =====")
        print(f"Total Income : Rs. {income_transactions:.2f}")
        print(f"Total Expense: Rs. {expense_transactions:.2f}")
    ...
    def filter_transactions(self):
        ...
        for txn in filtered:
            print(f"{txn['Date']} | {txn['Type']} | {txn['Category']} | Rs. {txn['Amount']:.2f} | {txn['Description']}")
        print("=================================\n")
    ...
    def monthly_report(self):
        ...
        if expense_by_category:
            ...
            print(f"\nHighest Expense Category: {highest_category} (Rs. {highest_amount:.2f})")
        else:
            print("\nNo expenses recorded this month.")
        ...
        if not previous_month_txns:
            ...
            print(f"Income Change : Rs. {total_income - prev_income:.2f}")
            print(f"Expense Change: Rs. {total_expense - prev_expense:.2f}")
